 ...
 */
public final class MISLDashMediaSource implements DashMediaSource {
   ...
   */
  public MISLDashMediaSource(DashManifest manifest, DashChunkSource.Factory chunkSourceFactory,
   ...
   * @param eventListener A listener of events. May be null if delivery of events is not required.
   */
  public MISLDashMediaSource(Uri manifestUri, DataSource.Factory manifestDataSourceFactory,
  ...
  private MISLDashMediaSource(DashManifest manifest, Uri manifestUri,
  ...
  public MediaPeriod createPeriod(int periodIndex, Allocator allocator, long positionUs) {
    ...
    DashMediaPeriod mediaPeriod = new MISLDashMediaPeriod(firstPeriodId + periodIndex, manifest,
  ...
  private long getNowUnixTimeUs() {
    ...
    public void onLoadCanceled(ParsingLoadable<DashManifest> loadable,
      ...
      MISLDashMediaSource.this.onLoadCanceled(loadable, elapsedRealtimeMs, loadDurationMs);
    }
