...
/**
 * A default {@link DashMediaPeriod} implementation.
 */
public final class DefaultDashMediaPeriod implements
        DashMediaPeriod {
  ...
  public DefaultDashMediaPeriod(int id, DashManifest manifest, int periodIndex,
  ...
  private ChunkSampleStream<DashChunkSource> buildSampleStream(int adaptationSetIndex,
    ...
    ChunkSampleStream<DashChunkSource> stream = new DefaultChunkSampleStream<>(adaptationSet.type,
