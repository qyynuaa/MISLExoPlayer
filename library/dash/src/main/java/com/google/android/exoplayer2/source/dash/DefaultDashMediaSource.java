 ...
 */
public final class DefaultDashMediaSource implements DashMediaSource {
   ...
   */
  public DefaultDashMediaSource(DashManifest manifest, DashChunkSource.Factory chunkSourceFactory,
   ...
   * @param eventListener A listener of events. May be null if delivery of events is not required.
   */
  public DefaultDashMediaSource(Uri manifestUri, DataSource.Factory manifestDataSourceFactory,
  ...
  private DefaultDashMediaSource(DashManifest manifest, Uri manifestUri,
  ...
  public MediaPeriod createPeriod(int periodIndex, Allocator allocator, long positionUs) {
    ...
    DashMediaPeriod mediaPeriod = new DefaultDashMediaPeriod(firstPeriodId + periodIndex, manifest,
    ...
    periodsById.put(mediaPeriod.getID(), mediaPeriod);
    return mediaPeriod;
  }
  ...
  public void releasePeriod(MediaPeriod mediaPeriod) {
    ...
    periodsById.remove(dashMediaPeriod.getID());
  }
  ...
  private long getNowUnixTimeUs() {
    ...
    public void onLoadCanceled(ParsingLoadable<DashManifest> loadable,
      ...
      DefaultDashMediaSource.this.onLoadCanceled(loadable, elapsedRealtimeMs, loadDurationMs);
    }
