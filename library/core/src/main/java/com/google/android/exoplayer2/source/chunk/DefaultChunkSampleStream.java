...
/**
 * A {@link ChunkSampleStream} implementation.
 */
public class DefaultChunkSampleStream<T extends ChunkSource> implements
        ChunkSampleStream<T> {
   ...
   */
  public DefaultChunkSampleStream(int primaryTrackType, int[] embeddedTrackTypes, T chunkSource,
  ...
  /**
   * A {@link SampleStream} embedded in a {@link DefaultChunkSampleStream}.
   */
